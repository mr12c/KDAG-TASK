...
function CallToActionSection({img,title1,title2,btnTitle}) {
  return (
    <div className='flex w-[90vw] mx-auto cta '>
        <img src={img} className='w-[43%]  ctaimg h-[25vw] ' />
        <div className='mt-10 ctadiv'>
        <div className='flex flex-col gap-5 h1wrp'>
        ...
        <NavLink to='/courses' className="bg-[#cf4242] ctabtn w-[7.5rem] mt-[6%] rounded-full group px-2 py-2 hover:scale-[1.02] text-[white] flex items-center  justify-center gap-3 font-semibold text-[1.2rem]">
                Explore
