...
let [imgs,setImg] = useState();
  ...
  return (
    <div className="w-[82vw]  mx-auto min-h-[100vh] bg-white pl-6 pt-8"> 
    ...
    <div className='w-[80%] '>
     ...
     {courseImg?  <img src={courseImg}></img> : <div className='w-full h-full bg-slate-300'></div>  }
      ...
      <div>
        ...
        <p className='w-[60%] text-[0.9rem] mt-2 capitalize font-semibold text-[#757575]'>{data?.description}</p>
        <div className='flex *:px-4 *:py-1 *:rounded-md gap-8 mt-14 '>
        ...
        <div className="details flex gap-20 mt-10 *:flex *:flex-col *:justify-center *:items-center *:gap-5 *:text-[1.4rem]">
             <div >
